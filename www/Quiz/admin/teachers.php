    ...
    if (isset($_POST['action'])) {
        ...
        if ($action === 'create' || $action === 'update') {
            ...
            if ($existing_username && ($action === 'create' || ($action === 'update' && $existing_username['id'] != $_POST['id']))) {
                ...
                adminMessageRedirect("Username already exists.", "teachers.php", false);
                exit;
            }
            ...
            if ($existing_email && ($action === 'create' || ($action === 'update' && $existing_email['id'] != $_POST['id']))) {
                ...
                adminMessageRedirect("Email already exists.", "teachers.php", false);
                exit;
            }
            ...
            if ($action === 'create') {
                ...
                if (!isset($data['password'])) {
                    ...
                    adminMessageRedirect("Password is required for creation.", "teachers.php", false);
                    exit;
                }
            ...
            if ($result) {
                ...
                adminMessageRedirect("User ".($action === 'create' ? "Created" : "Updated")." Successfully.", "teachers.php");
                exit;
            } else {
                // Handle error
                adminMessageRedirect("Failed to $action user", "teachers.php", false);
            }
        }
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="userFormModalLabel">Add/Edit Teacher</h5>
...
$(document).ready(function() {
    ...
    $('#usersTable').on('click', '.edit-user', function() {
        ...
        $('#userId').val(id);
        $('#action').val('update');
        $('#userFormModalLabel').text('Edit Teacher');
    ...
    $('#addUserButton').click(function() {
        ...
        $('#userId').val('');
        $('#action').val('create');
        $('#userFormModalLabel').text('Add Teacher');
        $('#userFormModal').modal('show');
    });
